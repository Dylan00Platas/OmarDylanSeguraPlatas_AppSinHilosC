...
class Program
{
    ...
    {
        Console.WriteLine("DoTrabajoPesado: Estoy levantando un elefante!");
        Thread.Sleep(1000);
    ...
    {
        Console.WriteLine("DoAlgo: holaaaa! Haciendo algo  por aquí");
    ...
    {
        Console.WriteLine("Dylan Platas: Desarrollo de sistemas en red \n");
